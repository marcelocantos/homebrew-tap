...
Homebrew formulae for [marcelocantos](https://github.com/marcelocantos) projects.

## Install

```
brew install marcelocantos/tap/<formula>
```
...
| [vellum](https://github.com/marcelocantos/vellum)           | Document preparation mcp server  markdown to pdf via goldmark + weasyprint (pri  | `brew install vellum`      |
